            ...
            <div className="col-xl-6 col-lg-8">
              <div className="product-details mb-30 pl-30">
                ...
                <div className="details-price mb-20">
                  <span>{props.selectedItem.final_price.toLocaleString()} VND</span>
                  <span className="old-price">{props.selectedItem.price.toLocaleString()} VND</span>
                </div>
                <div className="product-variant">
                  ...
                  <div className="product-info-list variant-item">
                    <ul>
                      <li><span>Brands:</span> {props.selectedItem.shop_name}</li>
